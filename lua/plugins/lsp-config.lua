		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- Show the signature of the function call you're currently writing.
					map("<leader>fs", vim.lsp.buf.signature_help, "Signature Help")
			...
			local servers = {
				...
				tsserver = function()
					...
					-- after volar 2.0.8
					-- local vue_ts_plugin_path = require("mason-registry").get_package("vue-language-server"):get_install_path()
					-- 	.. "/typescript-plugin"
